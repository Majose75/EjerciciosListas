...
let Array1 = []; //Creamos otro array vacio 
Array1 = nombres01.map(longitudElementoNombre);
console.log("PROBANDO: " + Array1);
function longitudElementoNombre(elemento) {
...
nombres02.forEach(imprimeNombre);
//- A�adir el nombre Jacinto en ambas listas
...
console.log("LISTA 1: " + nombres01); // As� saca todos los elementos de la lista a la vez
...
//Forma Majose, a�adiendo los elelemntos de las dos listas dierctmente en el nuevo array
let Array2 = [];
for (let c = 0; c < 7; c++) {
...
// 12. Devuelve true si alguno de los elementos de la colecci�n contiene una longitud de nombre > 6. Hacerlo para ambas listas.
function mayorSeis(element) {
